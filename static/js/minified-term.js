  ...
  var e = {
      290: (e, t, r) => {
        ...
        e.exports = function (e) {
          var t = c(this),
            r = s(t);
          if (!o(e)) throw new TypeError("Array#findIndex: predicate must be a function");
          for (var h = arguments.length > 1 ? arguments[1] : void 0, u = 0; u < r; ) {
            var f = l(u),
              p = n(t, f),
              d = a(i(e, h, [p, u, t]));
            if (d) return u;
      ...
      9018: (e, t, r) => {
        ...
        function c(e, t = !0) {
          ...
          const i = [],
            n = /\w+/g;
          for (; (r = n.exec(e)); ) t ? i.push(r.index) : i.push(r.index + r[0].length);
          return i;
        }
        function l(e, t) {
          const r = c(e, !0)
        ...
        function h(e, t, r) {
          let i = 0,
            n = 0;
          for (let o = 0; o < t; ++o) "\n" == e.charAt(o) ? ((n = 0), (i += 1)) : ((n += 1), n > r && ((n = 0), (i += 1)));
          return { row: i, col: n };
        }
        function u(e, t) {
        ...
        const w = "active",
          ...
          T = () => (document.visibilityState === k ? k : document.hasFocus() ? w : E);
        var D = new (class extends b {
            ...
            (this.s = e),
              ...
              L &&
                addEventListener("beforeunload", (e) => {
                  this.n = setTimeout(() => {
                    e.defaultPrevented || e.returnValue.length > 0 || this.r(e, k);
                  }, 0);
                });
          }
          get state() {
          ...
          addUnsavedChanges(e) {
            !this.i.indexOf(e) > -1 && (0 === this.i.length && addEventListener("beforeunload", O), this.i.push(e));
          }
          removeUnsavedChanges(e) {
            const t = this.i.indexOf(e);
            t > -1 && (this.i.splice(t, 1), 0 === this.i.length && removeEventListener("beforeunload", O));
          }
          r(e, t) {
            if (t !== this.s) {
              const r = ((e, t) => {
                for (let r, i = 0; (r = P[i]); ++i) {
                  const i = r[e],
                    n = r[t];
                  if (i >= 0 && n >= 0 && n > i) return Object.keys(r).slice(i, n + 1);
                }
                return [];
              })(this.s, t);
        ...
        function H() {
          var e;
          I.fit(), j.setOption("fontSize", ((e = window.innerWidth), Math.min(Math.max(Math.round(e / 50), 13), 20)));
        }
        j.loadAddon(I),
              ...
              y.run(r).then((e) => {
                "" !== e &&
                  ...
                  (function () {
                    ...
                    document.querySelector(".xterm-helper-textarea").dispatchEvent(e);
                  })());
              });
          }),
          document.addEventListener("DOMContentLoaded", function () {
            j.open(document.getElementById("xterm-container")), window.addEventListener("resize", H), H();
            const e = new (class {
                constructor(e, t = {}) {
                  (this.term = e),
                    ...
                    (this.maxAutocompleteEntries = t.maxAutocompleteEntries || 100),
                ...
                detach() {
                  this.term.off("data", this._handleTermData), this.term.off("resize", this._handleTermResize);
                }
                attach() {
                  this.term.onData(this._handleTermData), this.term.onResize(this._handleTermResize);
                }
                addAutocompleteHandler(e, ...t) {
                  this._autocompleteHandlers.push({ fn: e, args: t });
                }
                removeAutocompleteHandler(e) {
                  const t = this._autocompleteHandlers.findIndex((t) => t.fn === e);
                ...
                abortRead(e = "aborted") {
                  (null == this._activePrompt && null == this._activeCharPrompt) || this.term.write("\r\n"),
                    null != this._activePrompt && (this._activePrompt.reject(e), (this._activePrompt = null)),
                    null != this._activeCharPrompt && (this._activeCharPrompt.reject(e), (this._activeCharPrompt = null)),
                    (this._active = !1);
                }
                println(e) {
                  this.print(e + "\n");
                ...
                clearInput() {
                  ...
                  for (this.term.write("\r[K"), s = 1; s < t; ++s) this.term.write("[F[K");
                }
                setInput(e, t = !0) {
                ...
                setCursor(e) {
                  e < 0 && (e = 0), e > this._input.length && (e = this._input.length);
                  const t = this.applyPrompts(this._input),
                    r = (u(t, this._termSize.cols), this.applyPromptOffset(this._input, this._cursor)),
                ...
                handleCursorErase(e) {
                  ...
                  if (e) {
                    ...
                    this.clearInput(), (this._cursor -= 1), this.setInput(e, !1);
                  } else {
                ...
                handleTermResize(e) {
                  ...
                  this.clearInput(), (this._termSize = { cols: r, rows: t }), this.setInput(this._input, !1);
                }
                handleTermData(e) {
                  if (this._active) {
                    if (null != this._activeCharPrompt)
                      return this._activeCharPrompt.resolve(e), (this._activeCharPrompt = null), void this.term.write("\r\n");
                    ...
                    switch (e.substr(1)) {
                      ...
                      case "[B":
                        if (this.history) {
                          ...
                          e || (e = ""), this.setInput(e), this.setCursor(e.length);
                        }
                        break;
                      case "[D":
                      ...
                      case "[H":
                        ...
                        break;
                      case "b":
                        (r = l(this._input, this._cursor)), null != r && this.setCursor(r);
                        break;
                      case "f":
                        (r = (function (e, t) {
                      ...
                      case "":
                        (r = l(this._input, this._cursor)),
                          null != r &&
                            (this.setInput(this._input.substr(0, r) + this._input.substr(this._cursor)), this.setCursor(r));
                    }
                  else if (t < 32 || 127 === t)
                    switch (e) {
                      case "\r":
                        ...
                        if (this._autocompleteHandlers.length > 0) {
                          const e = this._input.substr(0, this._cursor),
                            ...
                            r = (function (e, t) {
                              ...
                              let i = r.length - 1,
                                n = r[i] || "";
                              "" === t.trim() ? ((i = 0), (n = "")) : f(t) && ((i += 1), (n = ""));
                              const o = e.reduce((e, { fn: t, args: n }) => {
                                try {
                                  return e.concat(t(i, r, ...n));
                                } catch (t) {
                                  return console.error("Auto-complete error:", t), e;
                                }
                              }, []);
                              return o.filter((e) => e.startsWith(n));
                            })(this._autocompleteHandlers, e);
                          if ((r.sort(), 0 === r.length)) t || this.handleCursorInsert("");
                          else if (1 === r.length) {
                            const t = (function (e) {
                              return "" === e.trim() || f(e) ? "" : (0, a.Q)(e).pop() || "";
                            })(e);
                            ...
                            r.length <= this.maxAutocompleteEntries
                              ...
                              : this.printAndRestartPrompt(() =>
                                  this.readChar(`Display all ${r.length} possibilities? (y or n)`).then((e) => {
              ...
              t = (function (e) {
                ...
                return (
                  ...
                  {
                    autocompleteCommonCommands: (e, r) => (0 === e ? t.filter((e) => "apply_" !== e).map((e) => e + " ") : []),
                    autocompleteCommonFiles: (t, r) => {
                      ...
                      if (o) {
                        const e = (function (e, t) {
                            if (!t) return e;
                            const r = (("/" === t.charAt(0) ? "" : e + "/") + t).split("/").filter((e) => !!e);
                            let i = 0;
                            for (let e = r.length - 1; e >= 0; e--) {
                              const t = r[e];
                              "." === t ? r.splice(e, 1) : ".." === t ? (r.splice(e, 1), i++) : i && (r.splice(e, 1), i--);
                            }
                            return "/" + r.join("/");
                          })(n, o),
                          t = g(i, e),
            ...
            const p = () => {
              e.read(`[92m${y.state.user}@${y.state.host}[97m [94m${y.state.workingDirectory}[97m $ `)
                .then((e) =>
                  "" === e
                    ? p()
                    : (o("command", { payload: e }),
      ...
      8075: (e) => {
        e.exports = function (e) {
          for (const [t, r] of Object.entries(e.system.aliases)) e.output(t + "='" + r.join(" ") + "'\n");
          e.exit();
        };
      },
      1395: (e, t, r) => {
      ...
      2045: (e) => {
        ...
        e.exports = function (e, r) {
          ...
          var i = r.findIndex(function (e) {
            ...
            n = -1 !== i;
          if ((n && r.splice(i, 1), !r.length)) return e.error("cp: missing file operand"), void e.exit(1);
          if (1 === r.length) return e.error("cp: missing destination file operand after ‘" + r[0] + "’"), void e.exit(1);
          var o = r[r.length - 1],
            s = r.slice(0, -1);
          function a(t, r) {
            return e.system.stat(t).then(function (i) {
              return "dir" !== i.type || n ? e.system.copy(t, r) : Promise.reject("cp: omitting directory ‘" + t + "’");
            });
          }
          e.system
            .stat(o)
            ...
            .catch(function () {
              return 1 !== s.length ? Promise.reject("cp: target ‘" + o + "’ is not a directory") : t;
            })
            .then(function (e) {
              return e === t
                ? a(s[0], o)
      ...
      6109: (e, t, r) => {
        ...
        e.exports = function (e, t) {
          ...
          l && h && ((h = r.lastIndexOf(o.USE_LONG_FORMAT) > r.lastIndexOf(o.SHOW_ENTRY_PER_ROW)), (l = !h));
                  ...
                  (function (t, r) {
                    const n = r.map((r) => e.system.stat(`${t}/${r}`)),
                      ...
                      a = (e, t) => {
                        const r = e.type === s,
                          i = t.type === s;
                        return r && !i ? -1 : !r && i ? 1 : e.name < t.name ? -1 : e.name > t.name ? 1 : 0;
                      },
                      c = (t) =>
                        h
                          ? ((t) => {
                              const r = t.type === s ? "drwxrwxr-x" : "-rw-rw-r--",
                                n = i("%5s", t.size),
                                a = ((e) => {
                                  const t = e.toString();
                                  return `${t.match(/(\w+\s\d+)/)[1]} ${t.match(/(\d+:\d+)/)[1]}`;
                                })(new Date(t.modified)),
                                c = ((e) => {
                                  const t = o(e);
                                  return e.type === s ? t + "/" : t;
      ...
      7492: (e) => {
        e.exports = function (e, t) {
          if ((t.shift(), !t.length)) return e.error("mkdir: missing operand"), void e.exit(1);
          Promise.all(
            t.map(function (t) {
      ...
      3243: (e) => {
        ...
        e.exports = function (e, r) {
          ...
          var i = r.findIndex(function (e) {
            ...
            n = -1 !== i;
          if ((n && r.splice(i, 1), !r.length)) return e.error("mv: missing file operand"), void e.exit(1);
          if (1 === r.length) return e.error("mv: missing destination file operand after ‘" + r[0] + "’"), void e.exit(1);
          var o = r[r.length - 1],
            s = r.slice(0, -1);
          function a(t, r) {
            return n
          ...
          e.system
            ...
            .catch(function () {
              return 1 !== s.length ? Promise.reject("mv: target ‘" + o + "’ is not a directory") : t;
            })
            .then(function (e) {
              return e === t
                ? a(s[0], o)
      ...
      887: (e) => {
        e.exports = function (e, t) {
          ...
          var r = t.findIndex(function (e) {
            ...
            i = -1 !== r;
          if ((i && t.splice(r, 1), !t.length)) return e.error("rm: missing operand"), void e.exit(1);
          Promise.all(
            t.map(function (t) {
              return e.system
                .stat(t)
                .then(
                  function (e) {
                    if ("dir" === e.type && !i) return Promise.reject("rm: cannot remove ‘" + t + "’: Is a directory");
                  },
                  function () {}
                )
                .then(function () {
      ...
      317: (e) => {
        e.exports = function (e, t) {
          if ((t.shift(), !t.length)) return e.error("rmdir: missing operand"), void e.exit(1);
          Promise.all(
            t.map(function (t) {
              return e.system
                .stat(t)
                .then(
                  function (e) {
                    if ("dir" !== e.type) return Promise.reject("rmdir: cannot remove ‘" + t + "’: Not a directory");
                  },
                  function () {}
                )
                .then(function () {
                ...
                .then(function (e) {
                  if (e.length) return Promise.reject("rmdir: failed to remove ‘" + t + "’: Directory not empty");
                })
                .then(function () {
                  return e.system.remove(t);
                });
      ...
      3156: (e) => {
        e.exports = function (e, t) {
          if ((t.shift(), !t.length)) return e.error("touch: missing file operand"), void e.exit(1);
          Promise.all(
            t.map(function (t) {
        ...
        e.exports = function (e) {
          ...
          function o(e) {
            return (function (e, t) {
              if (!t) return e;
              for (
                var r = (("/" === t.charAt(0) ? "" : e + "/") + t).split("/").filter(function (e) {
                    return !!e;
                  }),
                  i = 0,
                  n = r.length - 1;
                ...
                var o = r[n];
                "." === o ? r.splice(n, 1) : ".." === o ? (r.splice(n, 1), i++) : i && (r.splice(n, 1), i--);
              }
              return "/" + r.join("/");
          ...
          function s(e) {
            ...
            return a.stat(t).then(function (e) {
              return "dir" === e.type ? Promise.resolve() : Promise.reject(t + ": Is not a directory");
            });
          }
          var a = {
            commands: i,
            ...
            run: function (e) {
              t.history.push(e);
              const r = e.trim();
              if (["cat", "less", "more"].includes(r)) return Promise.reject(`${r}: missing operand`);
              ...
              if (!o[o.length - 1][0]) return Promise.reject("syntax error: unexpected end of file");
              if (
                o.find(function (e) {
                  return !e.length;
                })
            ...
            readDir: function (e) {
              var r = o(e);
              if (!t.fileSystem[r]) return Promise.reject("cannot access ‘" + e + "’: No such file or directory");
            ...
            createDir: function (e) {
              return a
                ...
                .then(
                  function () {
                    return Promise.reject("cannot create directory '" + e + "': File exists");
                  },
                  function () {
                    return s(e);
                  }
            ...
            write: function (e, r) {
              ...
              return s(e).then(function () {
                ...
                return a.stat(e).then(
                  function (e) {
                    if ("file" !== e.type) return Promise.reject(i + ": Is a folder");
            ...
            remove: function (e) {
              ...
              return t.fileSystem[r]
                ? (Object.keys(t.fileSystem).forEach(function (e) {
                  ...
                  Promise.resolve())
                : Promise.reject("cannot remove ‘" + e + "’: No such file or directory");
            },
            copy: function (e, r) {
              var i = o(e),
                n = o(r);
              if (!t.fileSystem[i]) return Promise.reject(e + ": No such file or directory");
              function a(e) {
                if (e.startsWith(i)) {
                  var r = e.replace(i, n);
            ...
            completeUp: function (e) {
              ...
              if (e !== r.input || i)
                ...
                if (!(r.index < r.list.length - 1)) return Promise.resolve(void 0);
                r.index++;
              }
              return Promise.resolve(r.list[r.index]);
            },
            completeDown: function (e) {
              return e === r.input && r.index ? (r.index--, Promise.resolve(r.list[r.index])) : Promise.resolve(void 0);
            },
          };
          return a;
        };
          ...
          return (
              ...
              return this.map(function (t) {
                var r = (function (e, t) {
                  ...
                  if (t && "function" == typeof btoa) {
                    var a =
                        ((r = s),
                        (i = btoa(unescape(encodeURIComponent(JSON.stringify(r))))),
                        (n = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(i)),
                        "/*# ".concat(n, " */")),
            ...
            (t.i = function (e, r, i) {
              ...
              for (var a = 0; a < e.length; a++) {
                var c = [].concat(e[a]);
                (i && n[c[0]]) || (r && (c[2] ? (c[2] = "".concat(r, " and ").concat(c[2])) : (c[2] = r)), t.push(c));
              }
            }),
            t
          );
      ...
      4289: (e, t, r) => {
        ...
        var i = r(2215),
          ...
          h = function (e, t, r, i) {
            var n;
            (!(t in e) || ("function" == typeof (n = i) && "[object Function]" === o.call(n) && i())) &&
              (l
                ? a(e, t, {
                    configurable: !0,
                    enumerable: !1,
      ...
      7272: (e, t, r) => {
        "use strict";
        var i = r(7642),
          n = "function" == typeof Symbol && "symbol" == typeof Symbol.unscopables,
          o = n && Array.prototype[Symbol.unscopables],
          s = TypeError;
        e.exports = function (e) {
          if ("string" != typeof e || !e) throw new s("method must be a non-empty string");
          if (!i(Array.prototype, e)) throw new s("method must be on Array.prototype");
          n && (o[e] = !0);
        };
      },
      1503: (e, t, r) => {
        ...
        var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator,
          ...
          c = function (e, t) {
            ...
            var r,
              i,
              s,
              a = "string" === t ? ["toString", "valueOf"] : ["valueOf", "toString"];
            for (s = 0; s < a.length; ++s) if (((r = e[a[s]]), o(r) && ((i = r.call(e)), n(i)))) return i;
        ...
        e.exports = function (e) {
          ...
          if (
            ...
            i && (Symbol.toPrimitive ? (t = l(e, Symbol.toPrimitive)) : a(e) && (t = Symbol.prototype.valueOf)),
            void 0 !== t)
          ) {
            var o = t.call(e, r);
            if (n(o)) return o;
      ...
      7648: (e) => {
        ...
        e.exports = function (e) {
          var o = this;
          if ("function" != typeof o || i.call(o) !== n) throw new TypeError(t + o);
          for (
            var s,
            ...
            h.push("$" + u);
          if (
            ((s = Function("binder", "return function (" + h.join(",") + "){ return binder.apply(this,arguments); }")(c)),
            o.prototype)
          ) {
            var f = function () {};
      ...
      210: (e, t, r) => {
        ...
        var l = function () {
          ...
          _ = {
            ...
            "%MapIteratorPrototype%": "undefined" != typeof Map && u ? f(new Map()[Symbol.iterator]()) : i,
            "%Math%": Math,
            "%Number%": Number,
            "%Object%": Object,
            ...
            "%SetIteratorPrototype%": "undefined" != typeof Set && u ? f(new Set()[Symbol.iterator]()) : i,
        ...
        e.exports = function (e, t) {
          ...
          for (var f = 1, p = !0; f < r.length; f += 1) {
            ...
            if ((("constructor" !== d && p) || (h = !0), m(_, (a = "%" + (i += "." + d) + "%")))) l = _[a];
            else if (null != l) {
              if (!(d in l)) {
      ...
      8420: (e, t, r) => {
        ...
        var i,
          ...
          c = r(6410)();
        if (c) {
          (i = a("Object.prototype.hasOwnProperty")), (n = a("RegExp.prototype.exec")), (o = {});
          var l = function () {
            throw o;
          };
          (s = { toString: l, valueOf: l }), "symbol" == typeof Symbol.toPrimitive && (s[Symbol.toPrimitive] = l);
        }
        ...
        e.exports = c
          ...
          : function (e) {
              return !(!e || ("object" != typeof e && "function" != typeof e)) && "[object RegExp]" === h(e);
            };
      },
      2636: (e, t, r) => {
        "use strict";
      ...
      6748: (e, t, r) => {
        ...
        (R["[object Float32Array]"] =
          ...
          R["[object Uint32Array]"] =
            !0),
          (R[o] = R[s] = R[b] = R[a] = R[S] = R[c] = R[l] = R[h] = R[u] = R[f] = R[p] = R[_] = R[v] = R[y] = R[m] = !1);
        ...
        function F(e, t) {
          for (var r = -1, i = e ? e.length : 0; ++r < i; ) if (t(e[r], r, e)) return !0;
          return !1;
        }
        function W(e) {
          var t = !1;
        ...
        var N,
          ...
          J = (N = /[^.]+$/.exec((Y && Y.keys && Y.keys.IE_PROTO) || "")) ? "Symbol(src)_1." + N : "",
          X = V.toString,
          Z = $.hasOwnProperty,
          Q = $.toString,
          ee = RegExp(
        ...
        function Oe(e, t) {
          for (var r = 0, i = (t = Fe(t, e) ? [t] : De(t)).length; null != e && r < i; ) e = e[Ne(t[r++])];
            ...
            (null == e || null == t || (!tt(e) && !rt(t))
              ...
              : (function (e, t, r, i, n, h) {
                  var d = Xe(e),
                    ...
                    C = s,
                    w = s;
                  d || (C = (C = He(e)) == o ? p : C), m || (w = (w = He(t)) == o ? p : w);
                  var E = C == p && !W(e),
                    k = w == p && !W(t),
                    x = C == w;
                  if (x && !E)
                      ...
                      d || nt(e)
                        ...
                        : (function (e, t, r, i, n, o, s) {
                            switch (r) {
                              ...
                              case v:
                                var p = 2 & o;
                                if ((h || (h = q), e.size != t.size && !p)) return !1;
                                var d = s.get(e);
                                if (d) return d == t;
                                (o |= 1), s.set(e, t);
                  ...
                  return (
                    ...
                    (function (e, t, r, i, n, o) {
                      ...
                      for (var p = s; ++l < c; ) {
                        var d = e[(h = a[l])],
                          _ = t[h];
                        if (i) var v = s ? i(_, d, h, t, e, o) : i(d, _, h, e, t, o);
        ...
        function Me(e, t, r, i, n, o) {
          ...
          for (o.set(e, t), o.set(t, e); ++h < a; ) {
            ...
            if (f) {
              if (
                !F(t, function (e, t) {
                  if (!f.has(t) && (p === e || r(p, e, i, n, o))) return f.add(t);
                })
              ) {
                u = !1;
                break;
        ...
        function Be(e, t) {
          return !!(t = null == t ? n : t) && ("number" == typeof e || L.test(e)) && e > -1 && e % 1 == 0 && e < t;
        }
        function Fe(e, t) {
          if (Xe(e)) return !1;
          var r = typeof e;
          return (
            !("number" != r && "symbol" != r && "boolean" != r && null != e && !it(e)) ||
            w.test(e) ||
            !C.test(e) ||
                              ...
                              return void 0 === i && i === t
                                ? (function (e, t) {
                                    return (
                                      null != e &&
                                      (function (e, t, r) {
                                        for (var i, n = -1, o = (t = Fe(t, e) ? [t] : De(t)).length; ++n < o; ) {
                                          var s = Ne(t[n]);
                                          if (!(i = null != e && r(e, s))) break;
                                          e = e[s];
                                        }
                                        return i || (!!(o = e ? e.length : 0) && et(o) && Be(s, o) && (Xe(e) || Je(e)));
                                      })(e, t, Pe)
                                    );
                                  })(r, e)
                                : Te(t, i, void 0, 3);
                          ...
                          (function (e, t, r, i) {
                            ...
                            for (; ++n < o; ) {
                              ...
                              if (s[2]) {
                                ...
                                var h,
                                  u = new Ee();
                                if (!(void 0 === h ? Te(l, c, i, 3, u) : h)) return !1;
                              }
                            }
                            return !0;
                          })(e, 0, n)
          ...
          return Ze(e)
            ? (function (e, t) {
                var r =
                  ...
                  i = r.length,
                  n = !!i;
                for (var o in e) (!t && !Z.call(e, o)) || (n && ("length" == o || Be(o, i))) || r.push(o);
                return r;
              })(e)
            : (function (e) {
                if (((r = (t = e) && t.constructor), t !== (("function" == typeof r && r.prototype) || $))) return oe(e);
                var t,
                  r,
                  i = [];
                for (var n in Object(e)) Z.call(e, n) && "constructor" != n && i.push(n);
                return i;
              })(e);
        }
        function st(e) {
      ...
      631: (e, t, r) => {
        ...
        e.exports = function e(t, r, i, n) {
          ...
          if ((void 0 === i && (i = 0), i >= x && x > 0 && "object" == typeof t)) return W(t) ? "[Array]" : "[Object]";
          var L,
            I = (function (e, t) {
              var r;
              if ("\t" === e.indent) r = "\t";
          ...
          function N(t, r, o) {
            if ((r && (n = k.call(n)).push(r), o)) {
              var s = { depth: a.depth };
              return z(a, "quoteStyle") && (s.quoteStyle = a.quoteStyle), e(t, s, i + 1, n);
            }
            return e(t, a, i + 1, n);
          }
          if ("function" == typeof t && !U(t)) {
            var $ = (function (e) {
              ...
              ee = Q(t, N);
            return (
              "[Function" + ($ ? ": " + $ : " (anonymous)") + "]" + (ee.length > 0 ? " { " + E.call(ee, ", ") + " }" : "")
            );
          }
          if (q(t)) {
            var te = O ? m.call(String(t), /^(Symbol\(.*\))_[^)]*$/, "$1") : R.call(t);
          ...
          if (
            ...
            for (var re = "<" + S.call(String(t.nodeName)), ie = t.attributes || [], ne = 0; ne < ie.length; ne++)
              re += " " + ie[ne].name + "=" + B(F(ie[ne].value), "double", a);
            return (
              (re += ">"), t.childNodes && t.childNodes.length && (re += "..."), re + "</" + S.call(String(t.nodeName)) + ">"
            );
          }
          if (W(t)) {
          ...
          if (
            ...
            return "cause" in Error.prototype || !("cause" in t) || T.call(t, "cause")
              ? 0 === se.length
                ? "[" + String(t) + "]"
                : "{ [" + String(t) + "] " + E.call(se, ", ") + " }"
              : "{ [" + String(t) + "] " + E.call(w.call("[cause]: " + N(t.cause), se), ", ") + " }";
          }
          if ("object" == typeof t && c) {
            if (H && "function" == typeof t[H] && j) return j(t, { depth: x - i });
          ...
          if (
            ...
            var le = Q(t, N),
              he = D ? D(t) === Object.prototype : t instanceof Object || t.constructor === Object,
              ue = t instanceof Object ? "" : "null prototype",
              fe = !he && P && Object(t) === t && P in t ? g.call(K(t), 8, -1) : ue ? "Object" : "",
              pe =
                (he || "function" != typeof t.constructor ? "" : t.constructor.name ? t.constructor.name + " " : "") +
                (fe || ue ? "[" + E.call(w.call([], fe || [], ue || []), ": ") + "] " : "");
            return 0 === le.length ? pe + "{}" : I ? pe + "{" + Z(le, I) + "}" : pe + "{ " + E.call(le, ", ") + " }";
          }
          return String(t);
        };
        var N =
        ...
        function V(e, t) {
          ...
          return B(m.call(m.call(e, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, $), "single", t);
        }
        function $(e) {
          ...
          for (var c in e)
            z(e, c) &&
              ((r && String(Number(c)) === c && c < e.length) ||
                ...
                (C.call(/[^\w$]/, c) ? i.push(t(c, e) + ": " + t(e[c], e)) : i.push(c + ": " + t(e[c], e))));
          if ("function" == typeof L)
            for (var l = 0; l < s.length; l++) T.call(e, s[l]) && i.push("[" + t(s[l]) + "]: " + t(e[s[l]], e));
          return i;
        }
      },
      8987: (e, t, r) => {
        ...
        if (!Object.keys) {
          ...
          i = function (e) {
            ...
            var d = l && r;
            if (a && e.length > 0 && !n.call(e, 0)) for (var _ = 0; _ < e.length; ++_) f.push(String(_));
            if (i && e.length > 0) for (var v = 0; v < e.length; ++v) f.push(String(v));
            else for (var y in e) (d && "prototype" === y) || !n.call(e, y) || f.push(String(y));
            if (c)
              for (
                var g = (function (e) {
                ...
                (g && "constructor" === h[m]) || !n.call(e, h[m]) || f.push(h[m]);
            return f;
          };
        }
        e.exports = i;
            ...
            return a
              .map(function (e, n) {
                  ...
                  for (s = 0; s < e.length; s++) {
                    ...
                    if (((p = p || (!h && ("*" === d || "?" === d))), u)) (f += d), (u = !1);
                      ...
                      d === h
                        ...
                        ? (f += d)
                        : d === l
                        ? ((s += 1), (f += '"' === (d = e.charAt(s)) || d === l || "$" === d ? d : l + d))
                        : (f += "$" === d ? _() : d);
                    else if ('"' === d || "'" === d) h = d;
                    else {
                        ...
                        return (
                          ...
                          f.length
                            ? [
                                f,
                                {
                                  comment: e.slice(s + 1) + a.slice(n + 1).join(" "),
                                },
                              ]
                            : [
                                {
                ...
                function _() {
                  var r, i, n, a;
                  if (((s += 1), "{" === e.charAt(s))) {
                    if (((s += 1), "}" === e.charAt(s))) throw new Error("Bad substitution: " + e.substr(s - 2, 3));
                    if ((r = e.indexOf("}", s)) < 0) throw new Error("Bad substitution: " + e.substr(s));
                  ...
                  return (
                    (n = i),
                    void 0 === (a = "function" == typeof t ? t(n) : t[n]) && "" != n ? (a = "") : void 0 === a && (a = "$"),
                    "object" == typeof a ? "" + o + JSON.stringify(a) + o : "" + a
                  );
                }
              })
              .reduce(function (e, t) {
                ...
                return 1 === r.length
                  ...
                  : e.concat(
                      r.filter(Boolean).map(function (e) {
                        return RegExp("^" + o).test(e) ? JSON.parse(e.split(o)[1]) : e;
                      })
                    );
              }, []);
        };
              ...
              if ("string" == typeof e[i]) _ += e[i];
                ...
                if ((a = e[i]).keys)
                  for (r = t[p], s = 0; s < a.keys.length; s++) {
                    if (null == r)
                      throw new Error(
                        o('[sprintf] Cannot access property "%s" of undefined value "%s"', a.keys[s], a.keys[s - 1])
                      );
                    r = r[a.keys[s]];
                  }
                else r = a.param_no ? t[a.param_no] : t[p++];
                if (
                  (n.not_type.test(a.type) && n.not_primitive.test(a.type) && r instanceof Function && (r = r()),
                  n.numeric_arg.test(a.type) && "number" != typeof r && isNaN(r))
                )
          ...
          function l(e) {
            ...
            for (var t, r = e, i = [], o = 0; r; ) {
              if (null !== (t = n.text.exec(r))) i.push(t[0]);
                ...
                if (null === (t = n.placeholder.exec(r))) throw new SyntaxError("[sprintf] unexpected placeholder");
                if (t[2]) {
                  o |= 1;
                  var s = [],
                    a = t[2],
          ...
          (function () {
            ...
            var e = (function () {
              ...
              t = function (e) {
                ...
                for (var i = ""; r; ) r % 2 == 1 && (i += t), r > 1 && (t += t), (r >>= 1);
                return i;
              };
            e
          ...
          (function () {
            ...
            var e = (function () {
              ...
              r = function (e) {
                ...
                if (o + c > i) return !1;
                for (var l = -1; ++l < o; ) if (r.charCodeAt(c + l) != n.charCodeAt(l)) return !1;
                return !0;
              };
            e
      ...
      3379: (e, t, r) => {
        ...
        function a(e, t) {
          for (var r = {}, i = [], n = 0; n < e.length; n++) {
            ...
            -1 !== u ? (o[u].references++, o[u].updater(f)) : o.push({ identifier: h, updater: _(f, t), references: 1 }),
              i.push(h);
          }
          return i;
        }
        ...
        function u(e, t, r, i) {
          var n = r ? "" : i.media ? "@media ".concat(i.media, " {").concat(i.css, "}") : i.css;
        ...
        function _(e, t) {
          ...
          if (t.singleton) {
            var o = d++;
            (r = p || (p = c(t))), (i = u.bind(null, r, o, !1)), (n = u.bind(null, r, o, !0));
          } else
            (r = c(t)),
              (i = f.bind(null, r, t)),
              (n = function () {
        ...
        e.exports = function (e, t) {
          (t = t || {}).singleton ||
            ...
            (t.singleton = (void 0 === i && (i = Boolean(window && document && document.all && !window.atob)), i));
          var r = a((e = e || []), t);
          return function (e) {
      ...
      2617: (e) => {
        window,
          (e.exports = (function (e) {
            ...
            function (e, t, r) {
              "use strict";
              Object.defineProperty(t, "__esModule", { value: !0 }), (t.FitAddon = void 0);
              var i = (function () {
                function e() {}
                return (
                  ...
                  (e.prototype.proposeDimensions = function () {
                    if (this._terminal && this._terminal.element && this._terminal.element.parentElement) {
                      var e = this._terminal._core,
                        ...
                        s =
                          i -
                          (parseInt(n.getPropertyValue("padding-right")) + parseInt(n.getPropertyValue("padding-left"))) -
          ...
          (e.exports = (() => {
            ...
            var e = {
                    ...
                    f = (function (e) {
                      ...
                      return (
                        ...
                        (t.prototype._onBoundaryFocus = function (e, t) {
                          ...
                          if (
                            r.getAttribute("aria-posinset") !== (0 === t ? "1" : "" + this._terminal.buffer.lines.length) &&
                            e.relatedTarget === i
                          ) {
                            var n, o;
                            if (
                        ...
                        (t.prototype._clearLiveRegion = function () {
                          (this._liveRegion.textContent = ""),
                            ...
                            s.isMac && u.removeElementFromParent(this._liveRegion);
                        }),
                      ...
                      function t(e, t, r) {
                        for (
                          var i = (e >> 24) & 255,
                            ...
                            l = (t >> 16) & 255,
                            h = (t >> 8) & 255,
                            u = a(n.relativeLuminance2(c, h, l), n.relativeLuminance2(i, o, s));
                          u < r && (c > 0 || l > 0 || h > 0);
                    ...
                    return (
                      ...
                      (e.prototype.setTheme = function (e) {
                        void 0 === e && (e = {}),
                          ...
                          (this.colors.selectionTransparent = this._parseColor(e.selection, l, !0)),
                          ...
                          i.color.isOpaque(this.colors.selectionTransparent) &&
                            (this.colors.selectionTransparent = i.color.opacity(this.colors.selectionTransparent, 0.3)),
                      ...
                      return (
                        ...
                        (e.prototype._linkifyRows = function () {
                          ...
                          if (void 0 !== this._rowsToLinkify.start && void 0 !== this._rowsToLinkify.end) {
                            ...
                            if (!(t >= e.lines.length)) {
                              for (
                                var r = e.ydisp + Math.min(this._rowsToLinkify.end, this._bufferService.rows) + 1,
                          ...
                          for (
                            var i,
                              ...
                              a = function () {
                                ...
                                if (!a)
                                  return c._logService.debug("match found without corresponding matchIndex", i, r), "break";
                    ...
                    u = (function (e) {
                      function t(t) {
                        ...
                        return (
                          ...
                          r.register(l.getDisposeArrayDisposable(r._linkCacheDisposables)),
                          r
                        );
                      }
                      return (
                        ...
                        (t.prototype.attachToDom = function (e, t, r) {
                          ...
                          (this._element = e),
                            ...
                            this.register(
                              h.addDisposableDomListener(this._element, "mouseleave", function () {
                                (i._isMouseOut = !0), i._clearCurrentLink();
                              })
                            ),
                            this.register(
                              h.addDisposableDomListener(this._element, "mousemove", this._onMouseMove.bind(this))
                            ),
                            this.register(h.addDisposableDomListener(this._element, "click", this._onClick.bind(this)));
                        }),
                        ...
                        (t.prototype._askForLink = function (e, t) {
                          ...
                          this._linkProviders.forEach(function (r, o) {
                            var s;
                            t
                              ? (null === (s = i._activeProviderReplies) || void 0 === s ? void 0 : s.get(o)) &&
                              ...
                              : r.provideLinks(e.y, function (t) {
                                  ...
                                  if (!i._isMouseOut) {
                                    ...
                                    null === (r = i._activeProviderReplies) || void 0 === r || r.set(o, a),
                                      (n = i._checkLinkProviderResult(o, e, n)),
                                      (null === (s = i._activeProviderReplies) || void 0 === s ? void 0 : s.size) ===
                                        i._linkProviders.length && i._removeIntersectingLinks(e.y, i._activeProviderReplies);
                                  }
                                });
                          });
                        }),
                          ...
                          for (var r = new Set(), i = 0; i < t.size; i++) {
                            ...
                            if (n)
                              for (var o = 0; o < n.length; o++)
                                for (
                                  var s = n[o],
                                    a = s.link.range.start.y < e ? 0 : s.link.range.start.x,
                                    c = s.link.range.end.y > e ? this._bufferService.cols : s.link.range.end.x,
                                    l = a;
                                  l <= c;
                                  l++
                                ) {
                        ...
                        (t.prototype._checkLinkProviderResult = function (e, t, r) {
                          ...
                          if (this._activeProviderReplies.size === this._linkProviders.length && !r)
                            for (a = 0; a < this._activeProviderReplies.size; a++) {
                              var l =
                                null === (i = this._activeProviderReplies.get(a)) || void 0 === i
                                  ? void 0
                                  : i.find(function (e) {
                                      return n._linkAtPosition(e.link, t);
                                    });
                            ...
                            r &&
                              ...
                              Object.defineProperties(e.link.decorations, {
                                pointerCursor: {
                                  get: function () {
                                    var e, r;
                                    return null === (r = null === (e = t._currentLink) || void 0 === e ? void 0 : e.state) ||
                                      void 0 === r
                                      ? void 0
                                  ...
                                  set: function (e) {
                                    var r, i;
                                    (null === (r = t._currentLink) || void 0 === r ? void 0 : r.state) &&
                                ...
                                underline: {
                                  ...
                                  set: function (r) {
                                    var i, n, o;
                                    (null === (i = t._currentLink) || void 0 === i ? void 0 : i.state) &&
                                      (null === (o = null === (n = t._currentLink) || void 0 === n ? void 0 : n.state) ||
                                      void 0 === o
                                        ? void 0
                  ...
                  var a = r(844),
                    ...
                    u = (function (e) {
                      ...
                      return (
                        ...
                        (t.prototype.clearAll = function (e, t) {
                          if (0 !== this._zones.length) {
                            ...
                            for (var r = 0; r < this._zones.length; r++) {
                              var i = this._zones[r];
                              ((i.y1 > e && i.y1 <= t + 1) || (i.y2 > e && i.y2 <= t + 1) || (i.y1 < e && i.y2 > t + 1)) &&
                                (this._currentZone &&
                                  this._currentZone === i &&
                        ...
                        o(
                          [s(2, h.IBufferService), s(3, l.IMouseService), s(4, l.ISelectionService), s(5, h.IOptionsService)],
                          t
                        )
                      );
                    })(a.Disposable);
                    ...
                    D = (function (e) {
                      function t(t) {
                        ...
                        return (
                          ...
                          r._setup(),
                          (r.linkifier = r._instantiationService.createInstance(u.Linkifier)),
                          (r.linkifier2 = r.register(r._instantiationService.createInstance(L.Linkifier2))),
                          r.register(
                          ...
                          r.register(S.forwardEvent(r._inputHandler.onCursorMove, r._onCursorMove)),
                          r.register(S.forwardEvent(r._inputHandler.onTitleChange, r._onTitleChange)),
                          r.register(S.forwardEvent(r._inputHandler.onA11yChar, r._onA11yCharEmitter)),
                          r.register(S.forwardEvent(r._inputHandler.onA11yTab, r._onA11yTabEmitter)),
                          r.register(
                      ...
                      return (
                        ...
                        (t.prototype._changeAnsiColor = function (e) {
                          ...
                          this._colorManager &&
                            ...
                            null === (t = this._renderService) || void 0 === t || t.setColors(this._colorManager.colors),
                            null === (r = this.viewport) || void 0 === r || r.onThemeChange(this._colorManager.colors));
                        }),
                        (t.prototype.dispose = function () {
                          var t, r, i;
                          this._isDisposed ||
                            ...
                            (this.write = function () {}),
                            null === (i = null === (r = this.element) || void 0 === r ? void 0 : r.parentNode) ||
                              void 0 === i ||
                            ...
                            case "screenReaderMode":
                              this.optionsService.options.screenReaderMode
                                ? !this._accessibilityManager &&
                                  this._renderService &&
                                  (this._accessibilityManager = new g.AccessibilityManager(this, this._renderService))
                                : (null === (o = this._accessibilityManager) || void 0 === o || o.dispose(),
                        ...
                        (t.prototype._onTextAreaFocus = function (e) {
                          this._coreService.decPrivateModes.sendFocus && this._coreService.triggerDataEvent(c.C0.ESC + "[I"),
                        ...
                        (t.prototype.open = function (e) {
                          ...
                          (this._viewportElement = T.createElement("div")),
                            ...
                            this.textarea.setAttribute("aria-label", _.promptLabel),
                          ...
                          var i = this._instantiationService.createInstance(R.CoreBrowserService, this.textarea);
                          this._instantiationService.setService(k.ICoreBrowserService, i),
                            ...
                            (this._colorManager = new w.ColorManager(T, this.options.allowTransparency)),
                            this.register(
                          ...
                          (this._renderService = this.register(
                            this._instantiationService.createInstance(E.RenderService, n, this.rows, this.screenElement)
                          )),
                            ...
                            (this._selectionService = this.register(
                              this._instantiationService.createInstance(f.SelectionService, this.element, this.screenElement)
                            )),
                          ...
                          function i(e) {
                            ...
                            switch (e.overrideType || e.type) {
                              case "mousemove":
                                (i = 32),
                                  void 0 === e.buttons
                                    ? ((r = 3), void 0 !== e.button && (r = e.button < 3 ? e.button : 3))
                                    : (r = 1 & e.buttons ? 0 : 4 & e.buttons ? 1 : 2 & e.buttons ? 2 : 3);
                                break;
                              case "mouseup":
                            ...
                            this._coreMouseService.onProtocolChange(function (t) {
                              t
                                ? ("debug" === e.optionsService.options.logLevel &&
                                    e._logService.debug("Binding to mouse events:", e._coreMouseService.explainEvents(t)),
                                ...
                                4 & t
                                  ...
                                  : (e._document.removeEventListener("mousemove", n.mousedrag), (n.mousedrag = null));
                            })
                          ),
                            ...
                            this.register(
                              d.addDisposableDomListener(r, "mousedown", function (t) {
                                if (
                                  (t.preventDefault(),
                                  e.focus(),
                                  e._coreMouseService.areMouseEventsActive && !e._selectionService.shouldForceSelection(t))
                                )
                                  return (
                                    i(t),
                        ...
                        (t.prototype._showCursor = function () {
                          this._coreService.isCursorInitialized ||
                            ((this._coreService.isCursorInitialized = !0), this.refresh(this.buffer.y, this.buffer.y));
                        }),
                        ...
                        (t.prototype._keyDown = function (e) {
                          if (
                            ((this._keyDownHandled = !1), this._customKeyEventHandler && !1 === this._customKeyEventHandler(e))
                          )
                            return !1;
                      ...
                      return (
                        ...
                        (t.prototype.syncScrollArea = function (e) {
                          if (
                            ...
                            return (
                              (this._lastRecordedBufferLength = this._bufferService.buffer.lines.length), void this._refresh(e)
                            );
                        ...
                        (t.prototype._onScroll = function (e) {
                          if (((this._lastScrollTop = this._viewportElement.scrollTop), this._viewportElement.offsetParent))
                            if (this._ignoreNextScrollEvent) this._ignoreNextScrollEvent = !1;
                              ...
                              var t =
                                Math.round(this._lastScrollTop / this._currentRowHeight) - this._bufferService.buffer.ydisp;
                        ...
                        (t.prototype._applyScrollModifier = function (e, t) {
                          ...
                          return ("alt" === r && t.altKey) || ("ctrl" === r && t.ctrlKey) || ("shift" === r && t.shiftKey)
                            ? e *
                        ...
                        o(
                          [s(3, h.IBufferService), s(4, h.IOptionsService), s(5, l.ICharSizeService), s(6, l.IRenderService)],
                          t
                        )
                      );
                    })(a.Disposable);
                              ...
                              setTimeout(function () {
                                ...
                                t._isSendingComposition &&
                                  ...
                                  (e = t._isComposing
                                    ...
                                    : t._textarea.value.substring(r.start)).length > 0 &&
                    ...
                    for (var s = e, a = t, c = ""; s !== r || a !== i; )
                      (s += n ? 1 : -1),
                        n && s > o.cols - 1
                          ...
                          : !n &&
                            s < 0 &&
                            ((c += o.buffer.translateBufferLineToString(a, !1, 0, e + 1)), (e = s = o.cols - 1), a--);
                    ...
                    h = (function () {
                      function e(e) {
                        ...
                        (this._core = e),
                          ...
                          (this._normal = new l(this._core.buffers.normal, "normal")),
                          (this._alternate = new l(this._core.buffers.alt, "alternate")),
                      ...
                      return (
                        ...
                        (e.prototype._drawChars = function (e, t, r) {
                          ...
                          a || e.isFgRGB() || e.isBgRGB()
                            ...
                            : (e.isInverse()
                              ...
                              (o += this._optionsService.options.drawBoldTextInBrightColors && e.isBold() && o < 8 ? 8 : 0),
                        ...
                        (e.prototype._drawUncachedChars = function (e, t, r, i) {
                          if (
                            ...
                            if (i) this._ctx.fillStyle = i.css;
                              ...
                              this._ctx.fillStyle = "rgb(" + s.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")";
                            else {
                              var o = e.getBgColor();
                              this._optionsService.options.drawBoldTextInBrightColors && e.isBold() && o < 8 && (o += 8),
                            ...
                            this._ctx.fillStyle = "rgb(" + s.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")";
                          else {
                            var a = e.getFgColor();
                            this._optionsService.options.drawBoldTextInBrightColors && e.isBold() && a < 8 && (a += 8),
                        ...
                        (e.prototype._getFont = function (e, t) {
                          return (
                            (t ? "italic" : "") +
                            " " +
                            (e ? this._optionsService.options.fontWeightBold : this._optionsService.options.fontWeight) +
                            " " +
                        ...
                        (e.prototype._getContrastColor = function (e) {
                          if (1 !== this._optionsService.options.minimumContrastRatio) {
                            ...
                            var u = this._resolveBackgroundRgba(o, n, s),
                              ...
                              p = c.rgba.ensureContrastRatio(u, f, this._optionsService.options.minimumContrastRatio);
                            if (p) {
                              var d = {
                                css: c.channels.toCss((p >> 24) & 255, (p >> 16) & 255, (p >> 8) & 255),
                                rgba: p,
                              };
                        ...
                        (e.prototype._resolveForegroundRgba = function (e, t, r, i) {
                          switch (e) {
                            ...
                            case 33554432:
                              return (
                                this._optionsService.options.drawBoldTextInBrightColors && i && t < 8 && (t += 8),
                  ...
                  var l = (function () {
                    ...
                    return (
                      ...
                      (e.prototype.getJoinedCharacters = function (e) {
                        ...
                        for (
                          var r = [], i = t.translateToString(!0), n = 0, o = 0, a = 0, c = t.getFg(0), l = t.getBg(0), h = 0;
                ...
                2512: function (e, t, r) {
                      ...
                      return (
                        ...
                        (t.prototype.onOptionsChanged = function () {
                          ...
                          this._optionsService.options.cursorBlink
                            ? this._cursorBlinkStateManager ||
                              (this._cursorBlinkStateManager = new l(this._coreBrowserService.isFocused, function () {
                                t._render(!0);
                              }))
                        ...
                        (t.prototype._render = function (e) {
                          if (this._coreService.isCursorInitialized && !this._coreService.isCursorHidden) {
                            ...
                            if (r < 0 || r >= this._bufferService.rows) this._clearCursor();
                              ...
                              if (
                                (this._bufferService.buffer.lines.get(t).loadCell(i, this._cell),
                  ...
                  var l = (function () {
                    ...
                    return (
                      ...
                      (e.prototype.dispose = function () {
                        this._blinkInterval && (window.clearInterval(this._blinkInterval), (this._blinkInterval = void 0)),
                  ...
                  var a = r(9596),
                    ...
                    g = (function (e) {
                      function t(t, r, i, n, o, s, f, p, d) {
                        ...
                        return (
                          (_._characterJoinerRegistry = new u.CharacterJoinerRegistry(_._bufferService)),
                          (_._renderLayers = [
                            ...
                            new c.SelectionRenderLayer(_._screenElement, 1, _._colors, _._id, _._bufferService, f),
                            new h.LinkRenderLayer(_._screenElement, 2, _._colors, _._id, i, n, _._bufferService, f),
                          ...
                          this._charSizeService.hasValidSize &&
                            ...
                            (this.dimensions.scaledCharTop =
                              1 === this._optionsService.options.lineHeight
                                ? 0
                                : Math.round((this.dimensions.scaledCellHeight - this.dimensions.scaledCharHeight) / 2)),
                            (this.dimensions.scaledCellWidth =
                              this.dimensions.scaledCharWidth + Math.round(this._optionsService.options.letterSpacing)),
                            ...
                            for (
                              ...
                              if (0 !== u.getWidth()) {
                                if (a.length > 0 && h === a[0][0]) {
                                  f = !0;
                                  var d = a.shift();
                                  (u = new l.JoinedCellData(this._workCell, s.translateToString(!0, d[0], d[1]), d[1] - d[0])),
                                    (p = d[1] - 1);
                                }
                                !f &&
                            ...
                            this._forEachCell(e, t, null, function (e, t, l) {
                              ...
                              e.isInverse()
                                ...
                                l !== s
                                  ...
                                  : c !== h && ((i.fillStyle = c || ""), r._fillCells(o, s, t - o, 1), (o = t), (s = l)),
                                (c = h);
                            }),
                            ...
                            if (!e.isInvisible() && (r._drawChars(e, t, i), e.isUnderline())) {
                              if ((r._ctx.save(), e.isInverse()))
                                if (e.isBgDefault()) r._ctx.fillStyle = r._colors.background.css;
                                  ...
                                  r._ctx.fillStyle = "rgb(" + a.AttributeData.toColorRGB(e.getBgColor()).join(",") + ")";
                                else {
                                  var n = e.getBgColor();
                                  r._optionsService.options.drawBoldTextInBrightColors && e.isBold() && n < 8 && (n += 8),
                                    (r._ctx.fillStyle = r._colors.ansi[n].css);
                                }
                              else if (e.isFgDefault()) r._ctx.fillStyle = r._colors.foreground.css;
                              else if (e.isFgRGB())
                                r._ctx.fillStyle = "rgb(" + a.AttributeData.toColorRGB(e.getFgColor()).join(",") + ")";
                              else {
                                var o = e.getFgColor();
                                r._optionsService.options.drawBoldTextInBrightColors && e.isBold() && o < 8 && (o += 8),
                ...
                1906: function (e, t, r) {
                  ...
                  function p(e) {
                    return (
                      (e.code << 21) | (e.bg << 12) | (e.fg << 3) | ((e.bold ? 0 : 4) + (e.dim ? 0 : 2) + (e.italic ? 0 : 1))
                    );
                  }
                    ...
                    return (
                      ...
                      (t.prototype.draw = function (e, t, r, i) {
                        ...
                        if (this._drawToCacheCount < 100) {
                          var s;
                          s =
                            this._cacheMap.size < this._cacheMap.capacity ? this._cacheMap.size : this._cacheMap.peek().index;
                      ...
                      (t.prototype._drawToCache = function (e, t) {
                        ...
                        this._config.allowTransparency ||
                          (a = (function (e, t) {
                            for (
                              var r = !0, i = t.rgba >>> 24, n = (t.rgba >>> 16) & 255, o = (t.rgba >>> 8) & 255, s = 0;
                              s < e.data.length;
                              s += 4
                            )
                    ...
                    b = (function (e) {
                      function t(t, r, i, n, o, s, c, l, h) {
                        ...
                        return (
                          ...
                          u._updateDimensions(),
                          u._injectCss(),
                          (u._rowFactory = new a.DomRendererRowFactory(document, u._optionsService, u._colors)),
                      ...
                      return (
                        ...
                        (t.prototype.dispose = function () {
                          this._element.classList.remove(_ + this._terminalClass),
                          ...
                          if (e && t) {
                            ...
                            if (!(o >= this._bufferService.rows || s < 0)) {
                              ...
                              if (r) a.appendChild(this._createSelectionElement(o, e[0], t[0], s - o + 1));
                                ...
                                var h = s - o - 1;
                                if (
                                  (a.appendChild(this._createSelectionElement(o + 1, 0, this._bufferService.cols, h)), o !== s)
                                ) {
                        ...
                        (t.prototype.renderRows = function (e, t) {
                          for (
                            var r = this._bufferService.buffer.ybase + this._bufferService.buffer.y,
                              i = Math.min(this._bufferService.buffer.x, this._bufferService.cols - 1),
                  ...
                  var a = (function () {
                    ...
                    return (
                      ...
                      (e.prototype.createRow = function (e, r, o, a, l, h, u) {
                        for (
                          var f = this._document.createDocumentFragment(), p = 0, d = Math.min(e.length, u) - 1;
                          d >= 0;
                          d--
                        )
                        ...
                        for (d = 0; d < p; d++) {
                          ...
                          if (0 !== _) {
                            ...
                            if ((_ > 1 && (v.style.width = h * _ + "px"), r && d === a))
                              switch ((v.classList.add(t.CURSOR_CLASS), l && v.classList.add(t.CURSOR_BLINK_CLASS), o)) {
                                case "bar":
                            ...
                            switch (g) {
                              ...
                              case 33554432:
                                this._workCell.isBold() &&
                                  ...
                                  (y += 8),
                                  this._applyMinimumContrast(v, this._colors.background, this._colors.ansi[y]) ||
                                    v.classList.add("xterm-fg-" + y);
                                break;
                              case 50331648:
                                var E = s.rgba.toColor((y >> 16) & 255, (y >> 8) & 255, 255 & y);
                                this._applyMinimumContrast(v, this._colors.background, E) ||
                                  this._addStyle(v, "color:#" + c(y.toString(16), "0", 6));
                                break;
                              default:
                                this._applyMinimumContrast(v, this._colors.background, this._colors.foreground) ||
                            ...
                            switch (b) {
                              ...
                              case 33554432:
                                ...
                                break;
                              case 50331648:
                                this._addStyle(v, "background-color:#" + c(m.toString(16), "0", 6));
                                break;
                              default:
                      ...
                      (e.prototype._applyMinimumContrast = function (e, t, r) {
                        ...
                        return (
                          void 0 === i &&
                            ((i = s.color.ensureContrastRatio(t, r, this._optionsService.options.minimumContrastRatio)),
                            this._colors.contrastCache.setColor(this._workCell.bg, this._workCell.fg, null != i ? i : null)),
                  ...
                  var r = (function () {
                    ...
                    return (
                      Object.defineProperty(e.prototype, "isFocused", {
                        get: function () {
                          return (
                            (this._textarea.getRootNode ? this._textarea.getRootNode() : document).activeElement ===
                              this._textarea && document.hasFocus()
                          );
                        },
                        enumerable: !1,
                        configurable: !0,
                      ...
                      return (
                        ...
                        (t.prototype._renderRows = function (e, t) {
                          this._renderer.renderRows(e, t),
                            ...
                            this._isNextRenderRedrawOnly || this._onRender.fire({ start: e, end: t }),
                        ...
                        o([s(3, f.IOptionsService), s(4, p.ICharSizeService), s(5, f.IBufferService)], t)
                      );
                    })(l.Disposable);
                  t.RenderService = d;
                },
                    ...
                    g = (function (e) {
                      function t(t, r, i, n, o, s, a) {
                        ...
                        return (
                          ...
                          (u._onLinuxMouseSelection = u.register(new h.EventEmitter())),
                          (u._onRedrawRequest = u.register(new h.EventEmitter())),
                          (u._onSelectionChange = u.register(new h.EventEmitter())),
                          (u._onRequestScrollLines = u.register(new h.EventEmitter())),
                          ...
                          u.register(
                            u._bufferService.buffers.onBufferActivate(function (e) {
                      ...
                      return (
                        ...
                        Object.defineProperty(t.prototype, "selectionText", {
                          get: function () {
                            ...
                            if (3 === this._activeSelectionMode) {
                              ...
                              for (
                                i.push(r.translateBufferLineToString(e[1], !0, e[0], s)), n = e[1] + 1;
                                n <= t[1] - 1;
                                n++
                              ) {
                                var c = r.lines.get(n);
                        ...
                        (t.prototype._getMouseEventScrollAmount = function (e) {
                          var t = p.getCoordsRelativeToElement(e, this._screenElement)[1],
                        ...
                        (t.prototype._dragScroll = function () {
                          if (this._model.selectionEnd && this._model.selectionStart && this._dragScrollAmount) {
                            ...
                            var e = this._bufferService.buffer;
                            this._dragScrollAmount > 0
                              ? (3 !== this._activeSelectionMode && (this._model.selectionEnd[0] = this._bufferService.cols),
                          ...
                          if ((void 0 === r && (r = !0), void 0 === i && (i = !0), !(e[0] >= this._bufferService.cols))) {
                            ...
                            if (o) {
                              ...
                              if (" " === s.charAt(a)) {
                                ...
                                var d = e[0],
                                  _ = e[0];
                                0 === o.getWidth(d) && (h++, d--), 2 === o.getWidth(_) && (u++, _++);
                                var v = o.getString(_).length;
                                for (
                                  v > 1 && ((p += v - 1), (c += v - 1));
                                  d > 0 && a > 0 && !this._isCharWordSeparator(o.loadCell(d - 1, this._workCell));

                                ) {
                                  o.loadCell(d - 1, this._workCell);
                                  var y = this._workCell.getChars().length;
                                  0 === this._workCell.getWidth() ? (h++, d--) : y > 1 && ((f += y - 1), (a -= y - 1)),
                                    a--,
                                    d--;
                                }
                                for (
                                  ...
                                  _ < o.length &&
                                  c + 1 < s.length &&
                                  !this._isCharWordSeparator(o.loadCell(_ + 1, this._workCell));

                                ) {
                                  o.loadCell(_ + 1, this._workCell);
                                  var g = this._workCell.getChars().length;
                                  2 === this._workCell.getWidth() ? (u++, _++) : g > 1 && ((p += g - 1), (c += g - 1)),
                                    c++,
                                    _++;
                                }
                              }
                              c++;
                              var m = a + l - h + f,
                                b = Math.min(this._bufferService.cols, c - a + h + u - f - p);
                              if (t || "" !== s.slice(a, c).trim()) {
                                ...
                                if (
                                  ...
                                  if (E && E.isWrapped && 32 !== E.getCodePoint(0)) {
                                    var k = this._getWordAt([0, e[1] + 1], !1, !1, !0);
                                    k && (b += k.length);
                                  }
                                }
                      ...
                      return (
                        ...
                        (e.prototype.playBellSound = function () {
                          ...
                          if (t) {
                            ...
                            t.decodeAudioData(
                              this._base64ToArrayBuffer(this._removeMimeType(this._optionsService.options.bellSound)),
                              function (e) {
                    ...
                    b = (function (e) {
                      function t(t) {
                        ...
                        return (
                          ...
                          r._instantiationService.setService(s.IOptionsService, r.optionsService),
                          (r._bufferService = r.register(r._instantiationService.createInstance(l.BufferService))),
                          r._instantiationService.setService(s.IBufferService, r._bufferService),
                          (r._logService = r._instantiationService.createInstance(c.LogService)),
                          r._instantiationService.setService(s.ILogService, r._logService),
                          (r._coreService = r.register(
                            r._instantiationService.createInstance(u.CoreService, function () {
                              return r.scrollToBottom();
                            })
                          )),
                          r._instantiationService.setService(s.ICoreService, r._coreService),
                          (r._coreMouseService = r._instantiationService.createInstance(p.CoreMouseService)),
                          r._instantiationService.setService(s.ICoreMouseService, r._coreMouseService),
                          (r._dirtyRowService = r._instantiationService.createInstance(d.DirtyRowService)),
                          r._instantiationService.setService(s.IDirtyRowService, r._dirtyRowService),
                          (r.unicodeService = r._instantiationService.createInstance(_.UnicodeService)),
                          r._instantiationService.setService(s.IUnicodeService, r.unicodeService),
                          (r._charsetService = r._instantiationService.createInstance(v.CharsetService)),
                          r._instantiationService.setService(s.ICharsetService, r._charsetService),
                          ...
                          r.register(f.forwardEvent(r._inputHandler.onLineFeed, r._onLineFeed)),
                          r.register(r._inputHandler),
                          r.register(f.forwardEvent(r._bufferService.onResize, r._onResize)),
                          r.register(f.forwardEvent(r._coreService.onData, r._onData)),
                          r.register(f.forwardEvent(r._coreService.onBinary, r._onBinary)),
                          r.register(
                      ...
                      return (
                        ...
                        (t.prototype.scroll = function (e, t) {
                          ...
                          if (0 === i.scrollTop) {
                            ...
                            o === i.lines.length - 1
                              ...
                              s
                                ? this._bufferService.isUserScrolling && (i.ydisp = Math.max(i.ydisp - 1, 0))
                                : (i.ybase++, this._bufferService.isUserScrolling || i.ydisp++);
                          } else {
                            var a = o - n + 1;
                            i.lines.shiftElements(n + 1, a - 1, -1), i.lines.set(o, r.clone());
                          }
                          this._bufferService.isUserScrolling || (i.ydisp = i.ybase),
                            this._dirtyRowService.markRangeDirty(i.scrollTop, i.scrollBottom),
                        ...
                        (t.prototype._enableWindowsMode = function () {
                          ...
                          if (!this._windowsMode) {
                            var t = [];
                            t.push(this.onLineFeed(y.updateWindowsModeWrappedState.bind(null, this._bufferService))),
                              t.push(
                                this.addCsiHandler({ final: "H" }, function () {
                                  return y.updateWindowsModeWrappedState(e._bufferService), !1;
                                })
                              ),
                              (this._windowsMode = {
                                dispose: function () {
                    ...
                    w = (function (e) {
                      function t(t, r, i, n, o, l, h, d, v) {
                        ...
                        (g._bufferService = t),
                          ...
                          (g._onRequestWindowsOptionsReport = new p.EventEmitter()),
                          ...
                          g._parser.setCsiHandler({ intermediates: " ", final: "@" }, function (e) {
                            return g.scrollLeft(e);
                          }),
                          g._parser.setCsiHandler({ final: "A" }, function (e) {
                            return g.cursorUp(e);
                          }),
                          g._parser.setCsiHandler({ intermediates: " ", final: "A" }, function (e) {
                          ...
                          g._parser.setCsiHandler({ prefix: "?", final: "J" }, function (e) {
                            return g.eraseInDisplay(e);
                          }),
                          g._parser.setCsiHandler({ final: "K" }, function (e) {
                            return g.eraseInLine(e);
                          }),
                          g._parser.setCsiHandler({ prefix: "?", final: "K" }, function (e) {
                            return g.eraseInLine(e);
                          }),
                          ...
                          g._parser.setCsiHandler({ prefix: ">", final: "c" }, function (e) {
                          ...
                          g._parser.setCsiHandler({ prefix: "?", final: "h" }, function (e) {
                            return g.setModePrivate(e);
                          }),
                          g._parser.setCsiHandler({ final: "l" }, function (e) {
                            return g.resetMode(e);
                          }),
                          g._parser.setCsiHandler({ prefix: "?", final: "l" }, function (e) {
                          ...
                          g._parser.setCsiHandler({ prefix: "?", final: "n" }, function (e) {
                            return g.deviceStatusPrivate(e);
                          }),
                          g._parser.setCsiHandler({ intermediates: "!", final: "p" }, function (e) {
                            return g.softReset(e);
                          }),
                          g._parser.setCsiHandler({ intermediates: " ", final: "q" }, function (e) {
                          ...
                          g._parser.setEscHandler({ intermediates: "%", final: "@" }, function () {
                            return g.selectDefaultCharset();
                          }),
                          g._parser.setEscHandler({ intermediates: "%", final: "G" }, function () {
                            return g.selectDefaultCharset();
                          });
                        var m = function (e) {
                            b._parser.setEscHandler({ intermediates: "(", final: e }, function () {
                        ...
                        return (
                          g._parser.setEscHandler({ intermediates: "#", final: "8" }, function () {
                          ...
                          g._parser.setDcsHandler(
                            ...
                            new C(g._bufferService, g._coreService, g._logService, g._optionsService)
                          ),
                          g
                        );
                      }
                      return (
                        ...
                        (t.prototype.print = function (e, t, r) {
                          ...
                          this._dirtyRowService.markDirty(o.y),
                            o.x &&
                              r - t > 0 &&
                              2 === p.getWidth(o.x - 1) &&
                              p.setCellFromCodePoint(o.x - 1, 0, 1, f.fg, f.bg, f.extended);
                          for (var _ = t; _ < r; ++_) {
                            if (((i = e[_]), (n = this._unicodeService.wcwidth(i)), i < 127 && s)) {
                            ...
                            if ((a && this._onA11yChar.fire(u.stringFromCodePoint(i)), n || !o.x)) {
                              if (o.x + n - 1 >= c)
                                if (l) {
                                  for (; o.x < c; ) p.setCellFromCodePoint(o.x++, 0, 1, f.fg, f.bg, f.extended);
                                  (o.x = 0),
                                    o.y++,
                                    o.y === o.scrollBottom + 1
                                      ? (o.y--, this._onRequestScroll.fire(this._eraseAttrData(), !0))
                                      : (o.y >= this._bufferService.rows && (o.y = this._bufferService.rows - 1),
                                        (o.lines.get(o.ybase + o.y).isWrapped = !0)),
                                    (p = o.lines.get(o.ybase + o.y));
                              ...
                              if (
                                ...
                                p.setCellFromCodePoint(o.x++, i, n, f.fg, f.bg, f.extended),
                                n > 0)
                              )
                                for (; --n; ) p.setCellFromCodePoint(o.x++, 0, 0, f.fg, f.bg, f.extended);
                          ...
                          r - t > 0 &&
                            ...
                            o.x < c &&
                              ...
                              0 === p.getWidth(o.x) &&
                              !p.hasContent(o.x) &&
                              p.setCellFromCodePoint(o.x, 0, 1, f.fg, f.bg, f.extended),
                            this._dirtyRowService.markDirty(o.y);
                        }),
                        (t.prototype.addCsiHandler = function (e, t) {
                          var r = this;
                        ...
                        (t.prototype.addOscHandler = function (e, t) {
                          return this._parser.addOscHandler(e, new y.OscHandler(t));
                        }),
                        (t.prototype.bell = function () {
                        ...
                        (t.prototype.lineFeed = function () {
                          ...
                          this._dirtyRowService.markDirty(e.y),
                            ...
                            e.y === e.scrollBottom + 1
                              ? (e.y--, this._onRequestScroll.fire(this._eraseAttrData()))
                        ...
                        (t.prototype.backspace = function () {
                          ...
                          if (!this._coreService.decPrivateModes.reverseWraparound)
                            return this._restrictCursor(), void (t.x > 0 && t.x--);
                          if ((this._restrictCursor(this._bufferService.cols), t.x > 0)) t.x--;
                          else if (
                            0 === t.x &&
                            t.y > t.scrollTop &&
                            t.y <= t.scrollBottom &&
                            (null === (e = t.lines.get(t.ybase + t.y)) || void 0 === e ? void 0 : e.isWrapped)
                          ) {
                          ...
                          if (!(this._bufferService.buffer.x >= this._bufferService.cols)) {
                            ...
                            (this._bufferService.buffer.x = this._bufferService.buffer.nextStop()),
                              this._optionsService.options.screenReaderMode &&
                                this._onA11yTab.fire(this._bufferService.buffer.x - e);
                          }
                        }),
                        ...
                        (t.prototype._restrictCursor = function (e) {
                          void 0 === e && (e = this._bufferService.cols - 1),
                            (this._bufferService.buffer.x = Math.min(e, Math.max(0, this._bufferService.buffer.x))),
                        ...
                        (t.prototype._moveCursor = function (e, t) {
                          this._restrictCursor(),
                            this._setCursor(this._bufferService.buffer.x + e, this._bufferService.buffer.y + t);
                        }),
                          ...
                          switch ((this._restrictCursor(), e.params[0])) {
                            ...
                            case 3:
                              ...
                              r > 0 &&
                                ...
                                (this._bufferService.buffer.ybase = Math.max(this._bufferService.buffer.ybase - r, 0)),
                                (this._bufferService.buffer.ydisp = Math.max(this._bufferService.buffer.ydisp - r, 0)),
                        ...
                        (t.prototype.scrollUp = function (e) {
                          for (var t = e.params[0] || 1, r = this._bufferService.buffer; t--; )
                            r.lines.splice(r.ybase + r.scrollTop, 1),
                              r.lines.splice(r.ybase + r.scrollBottom, 0, r.getBlankLine(this._eraseAttrData()));
                        ...
                        (t.prototype.scrollDown = function (e) {
                          for (var t = e.params[0] || 1, r = this._bufferService.buffer; t--; )
                            r.lines.splice(r.ybase + r.scrollBottom, 1),
                              r.lines.splice(r.ybase + r.scrollTop, 0, r.getBlankLine(f.DEFAULT_ATTR_DATA));
                          this._dirtyRowService.markRangeDirty(r.scrollTop, r.scrollBottom);
                        }),
                        ...
                        (t.prototype.insertColumns = function (e) {
                          ...
                          if (!(t.y > t.scrollBottom || t.y < t.scrollTop)) {
                            for (var r = e.params[0] || 1, i = t.scrollTop; i <= t.scrollBottom; ++i) {
                              ...
                              n.insertCells(t.x, r, t.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                                (n.isWrapped = !1);
                            }
                            this._dirtyRowService.markRangeDirty(t.scrollTop, t.scrollBottom);
                          }
                        ...
                        (t.prototype.deleteColumns = function (e) {
                          ...
                          if (!(t.y > t.scrollBottom || t.y < t.scrollTop)) {
                            for (var r = e.params[0] || 1, i = t.scrollTop; i <= t.scrollBottom; ++i) {
                              var n = t.lines.get(t.ybase + i);
                              n.deleteCells(t.x, r, t.getNullCell(this._eraseAttrData()), this._eraseAttrData()),
                                (n.isWrapped = !1);
                            }
                            this._dirtyRowService.markRangeDirty(t.scrollTop, t.scrollBottom);
                          }
                        ...
                        (t.prototype.sendDeviceAttributesPrimary = function (e) {
                          e.params[0] > 0 ||
                            (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen")
                              ...
                              : this._is("linux") && this._coreService.triggerDataEvent(s.C0.ESC + "[?6c"));
                        }),
                        (t.prototype.sendDeviceAttributesSecondary = function (e) {
                          e.params[0] > 0 ||
                            (this._is("xterm")
                              ? this._coreService.triggerDataEvent(s.C0.ESC + "[>0;276;0c")
                              : this._is("rxvt-unicode")
                              ? this._coreService.triggerDataEvent(s.C0.ESC + "[>85;95;0c")
                              : this._is("linux")
                              ? this._coreService.triggerDataEvent(e.params[0] + "c")
                              : this._is("screen") && this._coreService.triggerDataEvent(s.C0.ESC + "[>83;40003;0c"));
                        }),
                        ...
                        (t.prototype._updateAttrColor = function (e, t, r, i, n) {
                          return (
                            2 === t
                              ? ((e |= 50331648), (e &= -16777216), (e |= v.AttributeData.fromColorRGB([r, i, n])))
                              : 5 === t && ((e &= -50331904), (e |= 33554432 | (255 & r))),
                            e
                          );
                        }),
                        ...
                        (t.prototype.charAttributes = function (e) {
                          if (1 === e.length && 0 === e.params[0])
                            return (
                              ...
                              void (this._curAttrData.bg = f.DEFAULT_ATTR_DATA.bg)
                            );
                          for (var t, r = e.length, i = this._curAttrData, n = 0; n < r; n++)
                            (t = e.params[n]) >= 30 && t <= 37
                              ...
                              : 0 === t
                              ? ((i.fg = f.DEFAULT_ATTR_DATA.fg), (i.bg = f.DEFAULT_ATTR_DATA.bg))
                              : 1 === t
                              ? (i.fg |= 134217728)
                              : 3 === t
                              ? (i.bg |= 67108864)
                              : 4 === t
                              ? ((i.fg |= 268435456), this._processUnderline(e.hasSubParams(n) ? e.getSubParams(n)[0] : 1, i))
                              : 5 === t
                              ? (i.fg |= 536870912)
                              : 7 === t
                              ? (i.fg |= 67108864)
                              ...
                              ? (i.fg &= -1073741825)
                              : 39 === t
                              ? ((i.fg &= -67108864), (i.fg |= 16777215 & f.DEFAULT_ATTR_DATA.fg))
                              : 49 === t
                              ? ((i.bg &= -67108864), (i.bg |= 16777215 & f.DEFAULT_ATTR_DATA.bg))
                              : 38 === t || 48 === t || 58 === t
                              ? (n += this._extractColor(e, n, i))
                              : 59 === t
                              ? ((i.extended = i.extended.clone()), (i.extended.underlineColor = -1), i.updateExtended())
                              : 100 === t
                              ? ((i.fg &= -67108864),
                        ...
                        (t.prototype.windowOptions = function (e) {
                          if (S(e.params[0], this._optionsService.options.windowOptions)) {
                              ...
                              case 18:
                                this._bufferService &&
                                  this._coreService.triggerDataEvent(
                                    s.C0.ESC + "[8;" + this._bufferService.rows + ";" + this._bufferService.cols + "t"
                                  );
                                break;
                              case 22:
                                (0 !== t && 2 !== t) ||
                        ...
                        (t.prototype._parseAnsiColorChange = function (e) {
                          for (
                            var t, r = { colors: [] }, i = /(\d+);rgb:([0-9a-f]{2})\/([0-9a-f]{2})\/([0-9a-f]{2})/gi;
                            null !== (t = i.exec(e));
                        ...
                        (t.prototype.setAnsiColor = function (e) {
                          ...
                          t
                            ...
                            : this._logService.warn("Expected format <num>;rgb:<rr>/<gg>/<bb> but got data: " + e);
                        }),
                        ...
                        (t.prototype.selectCharset = function (e) {
                          2 === e.length
                            ? "/" !== e[0] && this._charsetService.setgCharset(m[e[0]], a.CHARSETS[e[1]] || a.DEFAULT_CHARSET)
                        ...
                        (t.prototype.reverseIndex = function () {
                          ...
                          if (e.y === e.scrollTop) {
                            ...
                            e.lines.shiftElements(e.ybase + e.y, t, 1),
                              e.lines.set(e.ybase + e.y, e.getBlankLine(this._eraseAttrData())),
                  ...
                  var u = (function () {
                    function e(e, t, r) {
                      (this._hasScrollback = e),
                        ...
                        (this.markers = []),
                        (this._nullCell = o.CellData.fromCharData([0, s.NULL_CELL_CHAR, s.NULL_CELL_WIDTH, s.NULL_CELL_CODE])),
                    ...
                    return (
                      ...
                      (e.prototype._reflowLargerAdjustViewport = function (e, t, r) {
                        for (var i = this.getNullCell(n.DEFAULT_ATTR_DATA), o = r; o-- > 0; )
                          0 === this.ybase
                            ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new n.BufferLine(e, i)))
                            : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
                        this.savedY = Math.max(this.savedY - r, 0);
                      }),
                      (e.prototype._reflowSmaller = function (e, t) {
                        for (
                          var r = this.getNullCell(n.DEFAULT_ATTR_DATA), i = [], o = 0, s = this.lines.length - 1;
                          s >= 0;
                          s--
                        ) {
                          ...
                          if (!(!c || (!c.isWrapped && c.getTrimmedLength() <= e))) {
                            ...
                            if (!(h >= s && h < s + l.length)) {
                              var u,
                                ...
                                p = a.reflowSmallerGetNewLineLengths(l, this._cols, e),
                                d = p.length - l.length;
                              u =
                              ...
                              for (var b = l.length - d - 1, S = f; b >= 0; ) {
                                var C = Math.min(S, m);
                                if (
                                  (l[g].copyCellsFrom(l[b], S - C, m - C, C, !0), 0 == (m -= C) && (m = p[--g]), 0 == (S -= C))
                                ) {
                                  b--;
                                  var w = Math.max(b, 0);
                              ...
                              for (v = 0; v < l.length; v++) p[v] < e && l[v].setCell(p[v], r);
                              for (var E = d - u; E-- > 0; )
                                0 === this.ybase
                                  ? this.y < t - 1
                        ...
                        if (i.length > 0) {
                          ...
                          var P = 0;
                          for (v = Math.min(this.lines.maxLength - 1, A + o - 1); v >= 0; v--)
                            if (O && O.start > L + P) {
                              for (var T = O.newLines.length - 1; T >= 0; T--) this.lines.set(v--, O.newLines[T]);
                              v++,
                                k.push({
                                  index: L + 1,
                          ...
                          for (v = k.length - 1; v >= 0; v--)
                            (k[v].index += D), this.lines.onInsertEmitter.fire(k[v]), (D += k[v].amount);
                      ...
                      (e.prototype.stringIndexToBufferIndex = function (e, t, r) {
                        for (void 0 === r && (r = !1); t; ) {
                          ...
                          for (var n = r ? i.getTrimmedLength() : i.length, o = 0; o < n; ++o)
                            if (
                              (i.get(o)[s.CHAR_DATA_WIDTH_INDEX] && (t -= i.get(o)[s.CHAR_DATA_CHAR_INDEX].length || 1), t < 0)
                            )
                              return [e, o];
                          e++;
                        }
                ...
                8437: (e, t, r) => {
                  ...
                  var a = (function () {
                    function e(e, t, r) {
                      ...
                      for (
                        var i = t || o.CellData.fromCharData([0, n.NULL_CELL_CHAR, n.NULL_CELL_WIDTH, n.NULL_CELL_CODE]),
                          s = 0;
                        s < e;
                        ++s
                      )
                    ...
                    return (
                      ...
                      (e.prototype.addCodepointToCell = function (e, t) {
                        ...
                        2097152 & r
                          ...
                          : (2097151 & r
                              ? ((this._combined[e] = i.stringFromCodePoint(2097151 & r) + i.stringFromCodePoint(t)),
                                (r &= -2097152),
                                (r |= 2097152))
                              : (r = t | (1 << 22)),
                            (this._data[3 * e + 0] = r));
                      ...
                      (e.prototype.resize = function (e, t) {
                        if (e !== this.length) {
                          if (e > this.length) {
                            ...
                            this.length &&
                              (3 * e < this._data.length ? r.set(this._data.subarray(0, 3 * e)) : r.set(this._data)),
                              (this._data = r);
                      ...
                      (e.prototype.translateToString = function (e, t, r) {
                        ...
                        for (var o = ""; t < r; ) {
                          var s = this._data[3 * t + 0],
                            a = 2097151 & s;
                          (o += 2097152 & s ? this._combined[t] : a ? i.stringFromCodePoint(a) : n.WHITESPACE_CELL_CHAR),
                            (t += s >> 22 || 1);
                        }
                        return o;
                      }),
                      ...
                      for (var s = [], a = 0; a < e.length - 1; a++) {
                        ...
                        if (l.isWrapped) {
                          ...
                          if (n >= a && n < c) a += h.length - 1;
                            ...
                            for (var u = 0, f = r(h, u, t), p = 1, d = 0; p < h.length; ) {
                              var _ = r(h, p, t),
                                v = _ - d,
                                y = i - f,
                                g = Math.min(v, y);
                              h[u].copyCellsFrom(h[p], d, f, g, !1),
                                ...
                                0 === f &&
                                  ...
                                  (h[u].copyCellsFrom(h[u - 1], i - 1, f++, 1, !1), h[u - 1].setCell(i - 1, o));
                            }
                        ...
                        (t.prototype.setFromCharData = function (e) {
                          ...
                          if (e[s.CHAR_DATA_CHAR_INDEX].length > 2) t = !0;
                            ...
                            if (55296 <= r && r <= 56319) {
                              ...
                              56320 <= i && i <= 57343
                                ? (this.content =
                                    (1024 * (r - 55296) + i - 56320 + 65536) | (e[s.CHAR_DATA_WIDTH_INDEX] << 22))
                                : (t = !0);
                            } else t = !0;
                  ...
                  var o = r(8460),
                    s = (function (e) {
                      function t(r) {
                        var i = e.call(this) || this;
                        return (
                          (i.line = r), (i._id = t._nextId++), (i.isDisposed = !1), (i._onDispose = new o.EventEmitter()), i
                        );
                      }
                      return (
                        n(t, e),
                        ...
                        (t.prototype.dispose = function () {
                          this.isDisposed ||
                            ((this.isDisposed = !0), (this.line = -1), this._onDispose.fire(), e.prototype.dispose.call(this));
                        }),
                        (t._nextId = 1),
                        t
                      );
                    ...
                    switch (e.keyCode) {
                      case 0:
                        "UIKeyInputUpArrow" === e.key
                          ...
                          : "UIKeyInputDownArrow" === e.key && (s.key = t ? i.C0.ESC + "OB" : i.C0.ESC + "[B");
                        break;
                      case 8:
                        if (e.shiftKey) {
                          s.key = i.C0.BS;
                        ...
                        if (!e.ctrlKey || e.shiftKey || e.altKey || e.metaKey)
                          if ((r && !o) || !e.altKey || e.metaKey)
                            !r || e.altKey || e.ctrlKey || e.shiftKey || !e.metaKey
                              ? e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && 1 === e.key.length
                                ? (s.key = e.key)
                  ...
                  Object.defineProperty(t, "__esModule", { value: !0 }),
                    ...
                    (t.utf32ToString = function (e, t, r) {
                      ...
                      for (var i = "", n = t; n < r; ++n) {
                        ...
                        o > 65535
                          ? ((o -= 65536),
                            (i += String.fromCharCode(55296 + (o >> 10)) + String.fromCharCode((o % 1024) + 56320)))
                    ...
                    return (
                      ...
                      (e.prototype.decode = function (e, t) {
                        ...
                        if (this.interim[0]) {
                          ...
                          for (var f = 0, p = void 0; (p = 63 & this.interim[++f]) && f < 4; ) (u <<= 6), (u |= p);
                          for (
                            var d = 192 == (224 & this.interim[0]) ? 2 : 224 == (240 & this.interim[0]) ? 3 : 4, _ = d - f;
                            l < _;
                        ...
                        for (var v = r - 4, y = l; y < r; ) {
                          ...
                          if ((i = e[y++]) < 128) t[a++] = i;
                            ...
                            if ((c = ((15 & i) << 12) | ((63 & n) << 6) | (63 & o)) < 2048 || (c >= 55296 && c <= 57343))
                              continue;
                            t[a++] = c;
                          } else if (240 == (248 & i)) {
                            if (y >= r) return (this.interim[0] = i), a;
                  ...
                  var c = (function () {
                    ...
                    return (
                      ...
                      (e.prototype.unhook = function (e) {
                        var t;
                        return (
                          this._hitLimit ? (t = !1) : e && (t = this._handler(this._data, this._params || new n.Params())),
                          (this._params = void 0),
                          (this._data = ""),
                          (this._hitLimit = !1),
                          t
                      ...
                      (r.prototype.parse = function (e, t) {
                        for (
                          ...
                          switch ((i = l[(n << 8) | ((r = e[h]) < 160 ? r : u)]) >> 4) {
                            ...
                            case 7:
                              for (
                                var p = this._csiHandlers[(a << 8) | r], d = p ? p.length - 1 : -1;
                                d >= 0 && !1 === p[d](c);
                                d--
                              );
                            ...
                            case 10:
                              for (
                                var _ = this._escHandlers[(a << 8) | r], v = _ ? _.length - 1 : -1;
                                v >= 0 && !1 === _[v]();
                                v--
                              );
                            ...
                            case 13:
                              for (var y = h + 1; ; ++y)
                                if (y >= t || 24 === (r = e[y]) || 26 === r || 27 === r || (r > 127 && r < u)) {
                                  s.put(e, h, y), (h = y - 1);
                                  break;
                                }
                              break;
                    ...
                    u = (function () {
                      ...
                      return (
                        ...
                        (e.prototype.triggerMouseEvent = function (e) {
                          ...
                          if (
                            (e.col++, e.row++, 32 === e.action && this._lastEvent && this._compareEvents(this._lastEvent, e))
                          )
                            return !1;
                ...
                4348: function (e, t, r) {
                  var i =
                    ...
                    function () {
                      ...
                      var i = Array(e),
                        n = 0;
                      for (t = 0; t < r; t++) for (var o = arguments[t], s = 0, a = o.length; s < a; s++, n++) i[n] = o[s];
                      return i;
                    };
                  Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                7866: function (e, t, r) {
                  ...
                  Object.defineProperty(t, "__esModule", { value: !0 }), (t.LogService = t.LogLevel = void 0);
                  var s,
                    a = r(2585);
                  !(function (e) {
                    (e[(e.DEBUG = 0)] = "DEBUG"),
      ...
      5537: (e, t, r) => {
        ...
        e.exports = function (e, t) {
          ...
          if (!o(t)) throw new i("Assertion failed: IsPropertyKey(P) is not true, got " + n(t));
          return e[t];
        };
      },
      863: (e, t, r) => {
      ...
      1856: (e, t, r) => {
        ...
        var i = r(210)("%TypeError%"),
          ...
          s = r(7858);
        e.exports = function (e) {
          if ("Object" !== s(e)) throw new i("Assertion failed: `obj` must be an Object");
          return o(n(e, "length"));
        };
      },
      1897: (e, t, r) => {
      ...
      8300: (e, t, r) => {
        ...
        var i = r(210),
          ...
          g = r(7858);
        e.exports = function e(t) {
          if ("String" !== g(t)) throw new s("Conversion from 'BigInt' to 'number' is not allowed.");
      ...
      7362: (e, t, r) => {
        ...
        e.exports = function (e) {
          var t = s(e) ? e : a(e, o);
          if ("symbol" == typeof t) throw new n("Cannot convert a Symbol value to a number");
          if ("bigint" == typeof t) throw new n("Conversion from 'BigInt' to 'number' is not allowed.");
